...
export default function QuickActions() {
  return (
    <div className="col-span-12 rounded-lg border border-gray-200 bg-white py-6 px-7.5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
      ...
      <div className="flex  flex-wrap gap-4">
        ...
        >
          <PlusIcon className="w-fit h-fit fill-current" />
          Create New Batch
        </Link>
        ...
        >
          <UserIcon className="w-fit h-fit fill-current" />
          Add Trainee
        </Link>
        ...
        >
          <PieChartIcon className="w-fit h-fit fill-current" />
          View Reports
        </Link>
      </div>
    </div>
