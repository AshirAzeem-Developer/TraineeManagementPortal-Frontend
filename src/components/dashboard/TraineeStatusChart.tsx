...
export default function TraineeStatusChart({ data }: TraineeStatusChartProps) {
  return (
    <div className="col-span-12 rounded-lg border border-gray-200 bg-white px-5 pt-7.5 pb-5 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:px-7.5 xl:col-span-4">
