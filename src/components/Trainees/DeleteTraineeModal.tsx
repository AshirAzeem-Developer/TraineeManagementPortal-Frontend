...
const DeleteTraineeModal: React.FC<DeleteTraineeModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  traineeName,
  ...
  return (
    ...
    >
      <ModalContent className="bg-white dark:bg-gray-900 rounded-2xl border border-red-200 dark:border-red-900/50 shadow-2xl">
        {(onClose) => (
          <>
            <ModalHeader className="flex items-center gap-3 px-6 py-5 border-b border-gray-200 dark:border-gray-800">
            ...
            <ModalBody className="px-6 py-6">
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-2 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <p>
                    This will permanently delete the trainee account.
                  </p>
                </div>
              </div>
            </ModalBody>
